    ...
    >
      ...
      >
        {thumbIcon && (
          <SwitchIconPrimitive
            position="thumb"
            className={cn("absolute [&_svg]:size-[9px] left-1/2 top-1/2 -translate-1/2 dark:text-neutral-500 text-neutral-400", iconClassName)}
          >
            {thumbIcon}
          </SwitchIconPrimitive>
        )}
      ...
      {startIcon && (
        <SwitchIconPrimitive
          position="left"
          className={cn("absolute [&_svg]:size-[9px] left-0.5 top-1/2 -translate-y-1/2 dark:text-neutral-500 text-neutral-400", startIconClassName)}
        >
          {startIcon}
        </SwitchIconPrimitive>
      )}
      {endIcon && (
        <SwitchIconPrimitive
          position="right"
          className={cn("absolute [&_svg]:size-[9px] right-0.5 top-1/2 -translate-y-1/2 dark:text-neutral-400 text-neutral-500", endIconClassName)}
        >
          {endIcon}
        </SwitchIconPrimitive>
      )}
